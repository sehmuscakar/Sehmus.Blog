...
namespace Sehmus.PresentationLayer.Areas.Admin.Controllers
{
    ...
    public class PasswordChangeController : Controller
    {
        ...
        public async Task<IActionResult> ForgetPassword(ForgetPasswordViewModel forgetPasswordViewModel)
        {
            ...
            client.Authenticate("sehmuscakar33@gmail.com", "iwgjtsuzkoielguv");//mail ve mailde oluşturduğun güvenlik kodu,bunu her bir ayrı projede ayrı al bu güvenlik kodunu mail üzerinden bazı işlmlerle alırsın
